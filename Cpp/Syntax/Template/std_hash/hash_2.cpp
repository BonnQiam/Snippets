...
#if 1
// 万能的 HashFunction 使用 variadic templates
...
int main() {
//    unordered_set<Customer, CustomerHash> unorderedSet;// corresponding to the first form

//    unordered_set<Customer,size_t(*)(const Customer&)>custset(20,customer_hash_func);// corresponding to the second form
    
//    unordered_set<Customer> unset; // corresponding to the third form

    int *p= reinterpret_cast<int *>(new Customer());
    cout<<hash_val(p)<<endl;// corresponding to the fourth form
