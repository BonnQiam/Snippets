#? This file is the modified version of the original file 'ivp.py' in SciPy
#? The modification is on the line 694
#? The purpose of the modification is to coorperate with the modified version of 'integrate.py' in autograd
...
def solve_ivp(fun, t_span, y0, args=(), method='RK45', t_eval=None, dense_output=False,
...
#              events=None, vectorized=False, args=None, **options):
    ...
    **options
    ...
    #! Take the final integration result as the solution
    return OdeResult(t=ts, y=ys, sol=sol, t_events=t_events, y_events=y_events,
                     nfev=solver.nfev, njev=solver.njev, nlu=solver.nlu,
                     status=status, message=message, success=status >= 0).y[:,-1]
#    return OdeResult(t=ts, y=ys, sol=sol, t_events=t_events, y_events=y_events,
#                     nfev=solver.nfev, njev=solver.njev, nlu=solver.nlu,
